...
(function (global) {
  ...
  var METHODS = {
    ...
    // طرق إضافية — الوطن العربي والعالم. معرّفات غير مستعملة سابقاً حتى لا تتغيّر إعدادات المستخدمين.
    9:  { name: 'الكويت', fajr: 18, isha: 17.5 },
    11: { name: 'قطر', fajr: 18, ishaMinutes: 90 },
    12: { name: 'اتحاد المنظمات الإسلامية بفرنسا (UOIF)', fajr: 12, isha: 12 },
    13: { name: 'تونس — وزارة الشؤون الدينية', fajr: 18, isha: 18 },
    14: { name: 'الجزائر — وزارة الشؤون الدينية', fajr: 18, isha: 17 },
    16: { name: 'المغرب — وزارة الأوقاف', fajr: 19, isha: 17 },
    17: { name: 'ماليزيا (JAKIM)', fajr: 20, isha: 18 },
    18: { name: 'إندونيسيا (KEMENAG)', fajr: 20, isha: 18 },
    19: { name: 'سنغافورة (MUIS)', fajr: 20, isha: 18 },
    20: { name: 'روسيا', fajr: 16, isha: 15 },
    21: { name: 'الأردن — وزارة الأوقاف', fajr: 18, isha: 18 },
    22: { name: 'منطقة الخليج', fajr: 19.5, ishaMinutes: 90 },
  };
